...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    welcome_msg = (
        "👋 <b>Welcome to DealSniffer!</b>\n\n"
        "✨ Discover the hottest deals and biggest savings on your favorite products.\n"
        "🔔 Get instant alerts, track price drops, and never miss a bargain!\n\n"
        "🚀 Ready to save? Use /help to explore all commands and features."
    )
