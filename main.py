...
# === CONFIG (FOR LOCAL VSCODE TESTING) ===
# Replace these placeholder values with your actual credentials before running the script.
TOKEN = "7803661072:AAExaeNquJJua6ODA_HmaPCZ5GypzduZrZg"
# For public channels use "@YourChannelName", for private channels use its ID like -1001234567890
CHANNEL_ID = "-1002259054611" 
AFFILIATE_TAG = "amasnag-21"
